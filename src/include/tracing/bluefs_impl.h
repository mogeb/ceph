...
static inline void __trace_balance_freespace_no_allocate(uint64_t gift, uint64_t min_alloc_size)
{
    tracepoint(bluefs, balance_freespace_no_allocate, gift, min_alloc_size);
}

#define trace_balance_freespace_no_allocate(__loglevel, __subsys, _type0, _name0, _value0, _type1, _name1, _value1, __format) __trace_balance_freespace_no_allocate(_value0, _value1)
