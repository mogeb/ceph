...
static inline void __trace_mkfs_create_using_fsid(string fsid, int generated)
{
    tracepoint(bluestore, mkfs_create_using_fsid, (char*)fsid.c_str(), generated);
}

#define trace_mkfs_create_using_fsid(__loglevel, __subsys, _type0, _name0, _value0, _type1, _name1, _value1, __format) __trace_mkfs_create_using_fsid(_value0, _value1)

static inline void __trace_mkfs_create_using_fsid_false(string fsid, int generated)
{
    tracepoint(bluestore, mkfs_create_using_fsid_false, (char*)fsid.c_str(), generated);
}

#define trace_mkfs_create_using_fsid_false(__loglevel, __subsys, _type0, _name0, _value0, _type1, _name1, _value1, __format) __trace_mkfs_create_using_fsid_false(_value0, _value1)
...
static inline void __trace_omap_setkeys(string cid, string oid, int r)
{
    tracepoint(bluestore, omap_setkeys, (char*)cid.c_str(), (char*)oid.c_str(), r);
}

#define trace_omap_setkeys(__loglevel, __subsys, _type0, _name0, _value0, _type1, _name1, _value1, _type2, _name2, _value2, __format) __trace_omap_setkeys(_value0, _value1, _value2)
